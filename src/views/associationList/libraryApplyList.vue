<template>
    <div>
        <div v-if="libraryApplyList">
            <listModel title="图书馆申请列表">
        ...
        <div v-if="libraryApply">
            <libraryApply @goBack="back()"></libraryApply>
        </div>
...
<script>
    ...
    import libraryApply from "../associationActivities/libraryApply";
    ...
    export default {
        ...
        methods:{
            add(){
                this.libraryApplyList=false
                this.libraryApply=true
                console.log(1);
            },
            back(){
                this.libraryApplyList=true
                this.libraryApply=false
                console.log(1);
            },
